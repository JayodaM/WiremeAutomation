...
public class TerminalPage {
    ...
    private final By SelectPartner = By.xpath("(//li[normalize-space()='partner1'])[1]");
    private final By Merchant = By.xpath("(//div[@role='button'])[4]");
    private final By SelectMID = By.xpath("(//li[normalize-space()='2356546 | merc1'])[1]");
    private final By Device = By.xpath("(//div[@role='button'])[5]");
    private final By DeviceSN = By.xpath("(//input[@placeholder='Search..'])[1]");
    private final By SelectDeviceSN = By.xpath("(//li[normalize-space()='123456789'])[1]");
    private final By SelectDeviceSN1 = By.xpath("(//li[normalize-space()='987654321'])[1]");
    private final By Currency = By.xpath("(//div[contains(text(),'LKR')])[1]");
    private final By SelectCurrency = By.xpath("(//li[normalize-space()='EUR'])[1]");
